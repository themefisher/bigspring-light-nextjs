...
<header class="header" style="text-align: center; margin: 10px; padding:10px"><img src="${process.env.NEXT_PUBLIC_BASE_URL}/images/logos/yuzi_lower_logo_600x200.svg" alt="Yuzi Care" width="300" height="100"></header>
...
<tbody>
<tr>
<td style="vertical-align: middle; width: 13.2454%;"><a href="https://yuzicare.com" target="_blank" rel="noopener"><img style="width: 150px; height: 50px;" src="${process.env.NEXT_PUBLIC_BASE_URL}/images/logos/email_signature_logo.svg" alt="Yuzi Care" alt="Yuzi Care Logo"> </a>
